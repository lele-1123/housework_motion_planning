...
def track_the_best_plan(idx=0):
    ...
    print("The cost of the best plan is {}.".format(cost))
    return trajectory
...
def real_time_dynamic_programming():
    ...
    while bellman_error > 0.0001:
        itr_num += 1
        bellman_error = 0.0
        rand_start: int = np.random.randint(low=0, high=4)
...
if __name__ == '__main__':
    ...
    plan2 = track_the_best_plan(3)
    visualize_the_best_plan(plan2, track_map)
